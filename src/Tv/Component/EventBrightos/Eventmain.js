    ...
    <div className="min-h-screen  bg-[#F3F3F3] py-16 px-4">
      <div className="">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">EventBrightos</h1>
          <p className="text-gray-600">Make  your event Bright with eventbrigtos</p>
        </div>
...
<div className="flex flex-1  justify-center items-center mb-40 md:mb-0">
  ...
  />
            ...
            {/* Title */}
            <h2 className=" text-gray-800 mt-16 font-semibold text-lg mb-6">Event brightos</h2>

            {/* Stats */}
            <div className=" space-y-2 mb-6">
              <p className="text-gray-600 text-sm">7+ years of experience</p>
              <p className="text-rose-400 text-sm font-medium">2k+ Projects Done</p>
            </div>
...
Events BrightOS organized a local service event in Gilgit focused on technology outreach.
The event included the distribution of digital tools and software solutions.
Local youth and aspiring developers actively participated.
The initiative aimed to promote digital literacy and entrepreneurship.
Community leaders appreciated eventsBrightOS’s contribution to Gilgit's tech ecosystem.
</p>
