        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
              At Shazii Enterprise, we offer a wide range of high-quality
              services across multiple industries, ensuring excellence and
              customer satisfaction in every project. Events BrightOS organized
              a local service event in Gilgit focused on technology outreach.
              The event included the distribution of digital tools and software
              solutions. Local youth and aspiring developers actively
              participated. The initiative aimed to promote digital literacy and
              entrepreneurship. Community leaders appreciated eventsBrightOS’s
              contribution to Gilgit's tech ecosystem.
            </p>
          </div>
