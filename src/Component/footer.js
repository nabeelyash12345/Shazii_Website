...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#E8B4B4] py-16 px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-4 gap-8">
          {/* Company Info Section */}
          <div className="flex flex-col">
            <div className="mb-6">
              <h2 className="text-4xl font-serif text-[#8B6B6B] mb-1">sc</h2>
              <p className="text-xs font-semibold text-[#8B6B6B] tracking-widest">SHAZII ENTERPRISES</p>
            </div>
            <p className="text-sm text-[#8B6B6B] leading-relaxed mb-6">
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-sm font-semibold text-[#8B6B6B] mb-6 uppercase tracking-wider">Company</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm text-[#8B6B6B] hover:text-[#6B5B5B] transition">
                  Home
                </a>
              </li>
              <li>
          ...
          {/* Learn More Links */}
          <div>
            <h3 className="text-sm font-semibold text-[#8B6B6B] mb-6 uppercase tracking-wider">Learn More</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm text-[#8B6B6B] hover:text-[#6B5B5B] transition">
                  Privacy Policy
          ...
          {/* Contact Form */}
          <div>
            <h3 className="text-sm font-semibold text-[#8B6B6B] mb-6 uppercase tracking-wider">Get In Touch</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-[#D9A5A5] text-[#8B6B6B] placeholder-[#A88888] focus:outline-none focus:ring-2 focus:ring-[#C99999] text-sm"
              />
              <input
                type="email"
                name="email"
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-[#D9A5A5] hover:bg-[#C99999] text-[#8B6B6B] font-semibold rounded-lg transition flex items-center justify-center gap-2 text-sm"
              >
