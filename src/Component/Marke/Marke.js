...
import line from "../../Assets/32.png";
import Footer from "../ItemCard/footer";
import WeddingCarousel from "../../Tv/Component/WeddingCard/WeddingCarousel";
    ...
    <>
      ...
      <section className="relative min-h-screen bg-[#F3F3F3] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen">
            ...
            <div className="flex flex-col justify-center space-y-8 py-12 lg:py-0">
              ...
              {/* Description */}
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl">
                JAN & SONS Tiles offers high-quality tiles for homes, offices,
                and commercial spaces. From classic to modern designs, we
                provide durable, stylish, and affordable flooring solutions to
                match every interior. Your trusted partner in building beauty
                that lasts.
              </p>
              ...
              <div className="mb-16">
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-3xl">
                  At JAN&SONS, we ensure a seamless and efficient process for
                  our clients to choose and avail our services. Follow these
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-14">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl">
            Our team at Marketos.pk is passionate and hardworking, driven by a
            commitment to excellence. With expert skills and a dedicated
            approach, we strive to deliver outstanding results,
          </p>
          <WeddingCarousel />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-14">
